---
title: "Maximum Likelihood Estimation: Categorical and Limited Dependent Variables"
...
#### 1. [Logit, Probit and the Generalized Linear Model](materials.html#logit-probit-glm)
...
#### 2. [Maximum Likelihood: Estimation and Interpretation](materials.html#ml-estimation-interpretation)
...
#### 3. [Issues in the Estimation and Interpretation of Logit and Probit Models](materials.html#logit-probit-issues)
...
#### 1. [Ordered Outcomes](materials.html#ordered-outcomes)
...
#### 2. [Nominal Outcomes](materials.html#nominal-outcomes)
...
#### 3. [Count Outcomes](materials.html#count-outcomes)
...
#### 4. [Censored Outcomes](materials.html#censored-outcomes)
...
#### 1. [Panel and Multilevel Models for Dichotomous Outcomes](materials.html#panel-multilevel-dichotomous)
...
#### 2. [Panel and Multilevel Models for Ordinal, Nominal and Count Outcomes](materials.html#panel-multilevel-ordinal)
...
#### 1. [Sample Selection, Endogenous Regressors and Endogenous Treatment Effects](materials.html#endogeneity-sample-selection)
